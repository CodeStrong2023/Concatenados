/*
Ejercicio 14: Leer dos series de 10 numeros enteros, que estaran ordenados crecientemente.
...
public class Arreglos_Ejercicio_14 {
    ...
    public static void main(String[] args) {
        ...
        while (i < 10 && j < 10) {
            if (a[i] < b[j]) {  //Si el elemento de "a" es menor al de "b"
