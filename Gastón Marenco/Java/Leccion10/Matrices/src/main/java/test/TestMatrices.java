...
//        }
        ...
        personas[0][0] = new Persona("Gaston");
        personas[0][1] = new Persona("Lionel");
        personas[0][2] = new Persona("Cristiano");
        personas[1][0] = new Persona("Kun");
        personas[1][1] = new Persona("Julian");
        personas[1][2] = new Persona("Ariel");
