// Ejercicio para encontar números pares e impares
let parImpar = 2;
if(parImpar % 2 == 0){
...
if(dentroRango >= valMin && dentroRango <= valMax){
    console.log("Esta dentro del rango establesido")
}
else{
    console.log("Esta fuera del rango establesido")
}
...
//Función isNaN
if(isNaN(edad2)){  //No es un número = Not a Number(devuelve un resultado booleano)
