...
console.log(juntos);
juntos = nombre + 78 + 17; //Aquí se puede diferenciar a través de los paréntessis
console.log(juntos);
juntos = 78 + 17 + nombre;
console.log(juntos);
...
let x, y; //Se pueden crear varia variables dentro de una misma línea
x = 17, y = 21; //Se puede hacer asignación de varias variables dentro de la misma línea
let z = x + y; //Se asigna el valor de la operacíon
console.log(z)
