...
public class TestFinal {
    public static void main(String[] args) {
        final int miDni = 38351239;
        System.out.println("miDni = " + miDni);
        // miDni = 38351238; NO se puede modificar
        // Persona.CONSTANTE_AQUI = 9; Un atributo constante no se puede modificar
        System.out.println("Mi atributo constante es: " +Persona.CONSTANTE_AQUI );
        
        final Persona persona1 = new Persona();
        // persona1 = new Persona(); No se puede asignar una nueva referencia
        persona1.setNombre("Franco Pieroni");
        System.out.println("persona1 = " + persona1.getNombre());
        persona1.setNombre("Guido");
        System.out.println("persona1 = " + persona1.getNombre());
        // Podemos modificar el valor del atributo pero no hacer una nueva referencia usando la palbra reservada final
